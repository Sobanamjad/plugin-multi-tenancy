...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('super-admin', 'tenant-admin', 'user');
  CREATE TYPE "public"."enum_products_category" AS ENUM('electronics', 'clothing', 'books', 'home-garden', 'sports', 'toys', 'food', 'other');
